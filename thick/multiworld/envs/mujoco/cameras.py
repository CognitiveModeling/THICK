...
def sawyer_pick_and_place_camera_fixed(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .67
    camera.lookat[2] = .1
    camera.distance = .7
...
def sawyer_pick_and_place_camera_zoomed_fixed(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .67
    camera.lookat[2] = .1
    camera.distance = .52
...
def sawyer_pick_and_place_camera_zoomed_fixed2(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .63
    camera.lookat[2] = .1
    camera.distance = .52
...
def sawyer_pick_and_place_camera_zoomed_fixed3(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .63
    camera.lookat[2] = .2
    camera.distance = .62
...
def sawyer_pick_and_place_camera_zoomed_fixed4(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .67
    camera.lookat[2] = .2
    camera.distance = .52
...
def sawyer_hook_camera_zoomed_fixed(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .57
    camera.lookat[2] = .1
    camera.distance = .52
...
def sawyer_pick_and_place_camera_slanted_fixed(camera):
    camera.lookat[0] = 0.0
    camera.lookat[1] = .57
    camera.lookat[2] = .1
    camera.distance = .75
    camera.elevation = 0
    camera.azimuth = 165#180
    camera.trackbodyid = -1
...
def sawyer_pick_and_place_camera_slanted_angle2(camera):
    camera.lookat[0] = 0.
    camera.lookat[1] = .6#.57
    camera.lookat[2] = .15
    camera.distance = .7#.65
    camera.elevation = -37.85
    camera.azimuth = 180
    camera.trackbodyid = -1
