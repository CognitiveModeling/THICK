...
class MultiSawyerEnv(MultitaskEnv, SawyerXYZEnv):
    def __init__(self,
        ...
        viewer_image_height = 84, viewer_image_width = 84, thick_first=100,
        ...
        self.num_objects, self.thick_first, self.substeps = num_objects, thick_first, substeps
    ...
    def reset(self):
        ...
        for _ in range(self.thick_first):
            for _ in range(20):
                # self._clip_gripper()
                try:
                    self.sim.step()
        ...
        finger_force /= 10 * self.thick_first
