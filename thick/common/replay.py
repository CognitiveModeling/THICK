...
class Replay:
  ...
  def __init__(
      ...
      prioritize_ends=False, load_directory=None):
    ...
    if load_directory is not None:
      print(f'Loading replay from {load_directory}')
      # load from a separate directory
      self._complete_eps = load_episodes(pathlib.Path(load_directory).expanduser(), capacity, minlen)
      self._total_episodes, self._total_steps = count_episodes(load_directory)
      print('Found #episodes = ', self._total_episodes)
    else:
      print(f'Loading replay from {directory}')
  ...
  def add_episode(self, episode):
    ...
    if length < self._minlen:
      ...
      print(f'Adding episode of length {length}.')
