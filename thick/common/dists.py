...
class OneHotDist(tfd.OneHotCategorical):
  ...
  def get_probs(self, sample_shape):
    return self._pad(super().probs_parameter(), sample_shape)

  def get_logits(self, sample_shape):
    return self._pad(super().logits_parameter(), sample_shape)
